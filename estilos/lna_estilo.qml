...
<qgis styleCategories="LayerConfiguration|Symbology|MapTips|AttributeTable|Rendering|CustomProperties|Temporal|Elevation|Notes" simplifyDrawingTol="1" simplifyMaxScale="1" symbologyReferenceScale="-1" maxScale="0" simplifyAlgorithm="0" minScale="100000000" version="3.44.7-Solothurn" autoRefreshTime="0" autoRefreshMode="Disabled" simplifyDrawingHints="1" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" readOnly="0">
  ...
  <elevation zoffset="0" type="IndividualFeatures" respectLayerSymbol="1" showMarkerSymbolInSurfacePlots="0" extrusionEnabled="0" clamping="Terrain" extrusion="0" zscale="1" customToleranceEnabled="1" binding="Centroid" symbology="Line">
    ...
    <profileLineSymbol>
      <symbol type="line" clip_to_extent="1" name="" alpha="1" is_animated="0" force_rhr="0" frame_rate="10">
        ...
        <layer pass="0" class="SimpleLine" id="{f0fc76f2-9347-4d97-9822-fde945e24134}" locked="0" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol type="fill" clip_to_extent="1" name="" alpha="1" is_animated="0" force_rhr="0" frame_rate="10">
        ...
        <layer pass="0" class="SimpleFill" id="{c4fd8da3-3600-4752-9406-db86e6702a37}" locked="0" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol type="marker" clip_to_extent="1" name="" alpha="1" is_animated="0" force_rhr="0" frame_rate="10">
        ...
        <layer pass="0" class="SimpleMarker" id="{b37d8f96-2580-4526-858d-03a46ee18123}" locked="0" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 type="singleSymbol" symbollevels="0" referencescale="-1" forceraster="0" enableorderby="0">
    <symbols>
      <symbol type="line" clip_to_extent="1" name="0" alpha="1" is_animated="0" force_rhr="0" frame_rate="10">
        ...
        <layer pass="0" class="MarkerLine" id="{9fb994ef-6bcd-429f-97c3-1303ffab8cf5}" locked="0" enabled="1">
          <Option type="Map">
          ...
          <symbol type="marker" clip_to_extent="1" name="@0@0" alpha="1" is_animated="0" force_rhr="0" frame_rate="10">
            ...
            <layer pass="0" class="SimpleMarker" id="{0acba7a5-2b10-4c99-8a49-1b63b8965eb0}" locked="0" enabled="1">
              <Option type="Map">
                <Option value="0" type="QString" name="angle"/>
                <Option value="square" type="QString" name="cap_style"/>
                ...
                <Option value="0,-3.94285700000000139" type="QString" name="offset"/>
                <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
                <Option value="MM" type="QString" name="offset_unit"/>
        ...
        <layer pass="0" class="SimpleLine" id="{928a45fb-c7d6-4643-bd70-5ba50678a95b}" locked="0" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="align_dash_pattern"/>
            <Option value="square" type="QString" name="capstyle"/>
            <Option value="5;2" type="QString" name="customdash"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="line" clip_to_extent="1" name="" alpha="1" is_animated="0" force_rhr="0" frame_rate="10">
        ...
        <layer pass="0" class="SimpleLine" id="{36693b34-952b-4e89-8949-8f273f551934}" locked="0" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="align_dash_pattern"/>
            <Option value="square" type="QString" name="capstyle"/>
            <Option value="5;2" type="QString" name="customdash"/>
  ...
  <customproperties>
    <Option type="Map">
      ...
      <Option type="List" name="dualview/previewExpressions">
        <Option value="COALESCE( &quot;nome&quot;, '&lt;NULL>' )" type="QString"/>
        <Option type="invalid"/>
        <Option value="COALESCE( &quot;nome&quot;, '&lt;NULL>' )" type="QString"/>
        <Option value="COALESCE( &quot;nome&quot;, '&lt;NULL>' )" type="QString"/>
        <Option type="invalid"/>
      ...
      <Option value="no label" type="QString" name="qgis2web/popup/nome"/>
      <Option value="no label" type="QString" name="qgis2web/popup/planilha"/>
      <Option value="no label" type="QString" name="qgis2web/popup/vizinho"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="vertice_inicial" hidden="0" width="-1"/>
      <column type="field" name="vertice_final" hidden="0" width="-1"/>
  ...
  <storedexpressions/>
  <previewExpression>COALESCE( "nome", '&lt;NULL>' )</previewExpression>
